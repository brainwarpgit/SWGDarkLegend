...
WeaponVariables::WeaponVariables() : Logger("WeaponVariables") {}

WeaponVariables::~WeaponVariables() {}

void WeaponVariables::startWeaponVariables() {
...
bool WeaponVariables::loadConfigData() {
...
bool WeaponVariables::fileExists(const std::string& filePath) {
	return (access(filePath.c_str(), F_OK) != -1);
}

time_t WeaponVariables::getFileModifiedTime(const std::string& filePath) {
...
void WeaponVariables::startWatching(const std::function<void()>& loadConfigFunction) {
