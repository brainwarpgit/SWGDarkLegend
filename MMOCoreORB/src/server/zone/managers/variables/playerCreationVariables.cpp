...
PlayerCreationVariables playerCreationVars;

PlayerCreationVariables::PlayerCreationVariables() : Logger("PlayerCreationVariables") {}

PlayerCreationVariables::~PlayerCreationVariables() {}

void PlayerCreationVariables::startPlayerCreationVariables() {
...
bool PlayerCreationVariables::loadConfigData() {
	const std::string luaFilePath = "scripts/managers/variables/playercreation_variables.lua";
...
bool PlayerCreationVariables::fileExists(const std::string& filePath) {
	return (access(filePath.c_str(), F_OK) != -1);
}

time_t PlayerCreationVariables::getFileModifiedTime(const std::string& filePath) {
...
void PlayerCreationVariables::startWatching(const std::function<void()>& loadConfigFunction) {
