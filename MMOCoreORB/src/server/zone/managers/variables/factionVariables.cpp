...
FactionVariables factionVars;

FactionVariables::FactionVariables() : Logger("FactionVariables") {}

FactionVariables::~FactionVariables() {}

void FactionVariables::startFactionVariables() {
...
bool FactionVariables::loadConfigData() {
	const std::string luaFilePath = "scripts/managers/variables/faction_variables.lua";
...
bool FactionVariables::fileExists(const std::string& filePath) {
	return (access(filePath.c_str(), F_OK) != -1);
}

time_t FactionVariables::getFileModifiedTime(const std::string& filePath) {
...
void FactionVariables::startWatching(const std::function<void()>& loadConfigFunction) {
