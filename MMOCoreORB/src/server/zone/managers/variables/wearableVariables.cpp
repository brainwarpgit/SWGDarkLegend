...
WearableVariables wearableVars;

WearableVariables::WearableVariables() : Logger("WearableVariables") {}

WearableVariables::~WearableVariables() {}

void WearableVariables::startWearableVariables() {
...
bool WearableVariables::loadConfigData() {
...
bool WearableVariables::fileExists(const std::string& filePath) {
	return (access(filePath.c_str(), F_OK) != -1);
}

time_t WearableVariables::getFileModifiedTime(const std::string& filePath) {
...
void WearableVariables::startWatching(const std::function<void()>& loadConfigFunction) {
