...
VehicleVariables vehicleVars;

VehicleVariables::VehicleVariables() : Logger("VehicleVariables") {}

VehicleVariables::~VehicleVariables() {}

void VehicleVariables::startVehicleVariables() {
...
bool VehicleVariables::loadConfigData() {
	const std::string luaFilePath = "scripts/managers/variables/vehicle_variables.lua";
...
bool VehicleVariables::fileExists(const std::string& filePath) {
	return (access(filePath.c_str(), F_OK) != -1);
}

time_t VehicleVariables::getFileModifiedTime(const std::string& filePath) {
...
void VehicleVariables::startWatching(const std::function<void()>& loadConfigFunction) {
