...
ResourceVariables resourceVars;

ResourceVariables::ResourceVariables() : Logger("ResourceVariables") {}

ResourceVariables::~ResourceVariables() {}

void ResourceVariables::startResourceVariables() {
...
bool ResourceVariables::loadConfigData() {
	const std::string luaFilePath = "scripts/managers/variables/resource_variables.lua";
...
bool ResourceVariables::fileExists(const std::string& filePath) {
	return (access(filePath.c_str(), F_OK) != -1);
}

time_t ResourceVariables::getFileModifiedTime(const std::string& filePath) {
...
void ResourceVariables::startWatching(const std::function<void()>& loadConfigFunction) {
