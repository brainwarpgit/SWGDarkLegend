...
int SharedLabratory::calculateAssemblySuccess(CreatureObject* player,DraftSchematic* draftSchematic, float effectiveness){
	...
	int forceSkill = player->getSkillMod("force_assembly");
	...
	//player->sendSystemMessage("cityBonus: " + std::to_string(cityBonus) + " assemblySkill: " + std::to_string(assemblySkill)+ " forceSkill: " + std::to_string(forceSkill) + " assemblyPoints: " + std::to_string(assemblyPoints) + " failMitigate: " + std::to_string(failMitigate) + " effectiveness: " + std::to_string(effectiveness) + " toolModifier: " + std::to_string(toolModifier) + " craftbonus: " + std::to_string(craftbonus) + " luckRoll: " + std::to_string(luckRoll));
	if(luckRoll > (95 - craftbonus) - forceSkill)
	...
	//player->sendSystemMessage("luckRoll: " + std::to_string(luckRoll) + " assemblyRoll: " + std::to_string(assemblyRoll));
