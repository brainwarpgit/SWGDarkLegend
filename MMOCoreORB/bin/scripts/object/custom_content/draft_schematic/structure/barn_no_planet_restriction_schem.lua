...
object_draft_schematic_structure_barn_no_planet_restriction = object_draft_schematic_structure_shared_barn_no_planet_restriction:new {

   templateType = DRAFTSCHEMATIC,

   --customObjectName = "Deed for: A Barn",
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_barn_no_planet_restriction, "object/draft_schematic/structure/barn_no_planet_restriction_schem.iff")
