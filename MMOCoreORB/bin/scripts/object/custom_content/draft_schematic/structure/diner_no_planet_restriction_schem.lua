...
object_draft_schematic_structure_diner_no_planet_restriction = object_draft_schematic_structure_shared_diner_no_planet_restriction:new {

   templateType = DRAFTSCHEMATIC,

   --customObjectName = "Deed for: A Diner",
...
ObjectTemplates:addTemplate(object_draft_schematic_structure_diner_no_planet_restriction, "object/draft_schematic/structure/diner_no_planet_restriction_schem.iff")
