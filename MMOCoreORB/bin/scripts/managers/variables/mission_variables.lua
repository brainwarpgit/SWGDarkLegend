...
missionEscortMissionDistance = 64 --default 64 // requires restart
missionEscortMissionDistanceEnabled = false --default true // requires restart
missionThemeParkFactionMultiplier = 10 --default 1 // requires restart
missionThemeParkCreditMultiplier = 10 --default 1 // requires restart
missionJediPadawanTrialsGrantXPEnabled = true --default false // requires restart
missionJediPadawanTrailsXP = 1250 --default 0   1250 to get enough for one novice box after trials. // requires restart
missionEnableJediKnightDestroyMissionsEnabled = true --default false // requires restart
