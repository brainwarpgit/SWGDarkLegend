...
caveRoriBlackSunOutpostBunvkerMultiplier = 5 --default 1 Ranges from 9 - 34
...
poiCorelliaRebelHideoutMultiplier = 1 --default 1 Ranges from 15 - 25
poiCorelliaRogueCorsecBaseMultiplier = 1 --default 1 Ranges from 9 - 16
poiCorelliaStrongholdMultiplier = 1 --default 1 Ranges from 14 - 35
poiDantooineAbandonedRebelBaseMultiplier = 1 --default 1 Ranges from 20 - 25
poiDantooineDantariVillageMultiplier = 1 --default 1 Ranges from 25 - 42
poiDantooineMokkStrongholdMultiplier = 1 --default 1 Ranges from 20 - 75
poiDathomirCrashSiteMultiplier = 1 --default 1 Ranges from 12 - 24
poiDathomirImperialPrisonMultiplier = 1 --default 1 Ranges from prisoners 12 - 27 / spiders 8 - 46 / imperials 14 - 35 / Force Sensative Renegade 80 / Giant Cavern Spider Recluse 116 / Mutant Rancor 75 / Nightsister Outcast 81 / Singing Mountain Clan Outcast 75 / AT-ST 125
poiDathomirNightsisterLaborCampMultiplier = 1 --default 1 Ranges from 15 - 131 / Nightsister Elder 278
poiDathomirNightsisterStrongholdMultiplier = 1 --default 1 Ranges from 15 - 131 / Nightsister Elder 278 / Axkva Min 302 
poiDathomirNightsisterVsSingingMountainMultiplier = 1 --default 1 Ranges from 21 - 156 / Nightsister Elder 278 / Singing Mountain Councilwoman 253
poiDathomirSarlaccMultiplier = 1 --default 1 Ranges from 24 - 98
poiDathomirSingingMountainClanMultiplier = 1 --default 1 Ranges from 10 - 156 / Singing Mountain Councilwoman 253
poiEndorDulokVillageNorthMultiplier = 1 --default 1 Ranges from 12 - 58
poiEndorDulokVillageSouthMultiplier = 1 --default 1 Ranges from 12 - 58
poiEndorEwokLakeVillage1Multiplier = 1 --default 1 Ranges from 5 - 56
poiEndorEwokLakeVillage2Multiplier = 1 --default 1 Ranges from 5 - 56
poiEndorEwokTreeVillage1Multiplier = 1 --default 1 Ranges from 24 - 30
poiEndorEwokTreeVillage2Multiplier = 1 --default 1 Ranges from 24 - 30
poiEndorMarauderStrongholdMultiplier = 1 --default 1 Ranges from 44 - 50
poiLokCanyonCorsairsStrongholdMultiplier = 1 --default 1 Ranges from 29 - 50
poiLokDownedBloodRazorTransportMultiplier = 1 --default 1 Ranges from 21 - 42 / Thug 7
poiLokImperialOutpostMultiplier = 1 --default 1 Ranges from 15 - 44 / Thug 4 / Commoner 7 / AT-ST 125 / Protocol Droid 100
poiLokKimogilaTownMultiplier = 1 --default 1 Ranges from 95 - 153 / Commoners 4
poiNabooAbandonedImperialOutpostMultiplier = 1 --default 1 Ranges from 7 - 12
poiNabooGunganSacredPlaceMultiplier = 1 --default 1 Ranges from 16 - 26
poiNabooGunganTempleMultiplier = 1 --default 1 Ranges from 9 - 21
poiNabooImperialVsGunganMultiplier = 1 --default 1 Ranges from 9 - 30
poiNabooMaulerStrongholdMultiplier = 1 --default 1 Ranges from 12 - 54
poiNabooMordranMultiplier = 1 --default 1 Ranges from 30 - 35 / Mordran 78
poiNabooWeaponTestingFacilityMultiplier = 1 --default 1 Ranges from 15 - 35 / Imperial Inquisitor 120
poiRoriCobralHideoutMultiplier = 1 --default 1 Ranges from 12 - 30
poiRoriGarynRaidersBunkerMultiplier = 1 --default 1 Ranges from 11 - 23
poiRoriGungansSwampTownMultiplier = 1 --default 1 Ranges from 17 - 73 / Thug 7
poiRoriHyperdriveResearchFacilityMultiplier = 1 --default 1 Ranges from 10 - 35 / ATST 125 / Imperial Inquisitor 120
poiRoriImperialEncampmentMultiplier = 1 --default 1 Ranges from 15 - 35 / ATST 125 / Thug 7
poiRoriPoacherVsCreatureBattleMultiplier = 1 --default 1 Ranges from 10 - 17
poiRoriRebelMilitaryBaseMultiplier = 1 --default 1 Ranges from 13 - 32
poiTalusCorsecVsFlailBattleMultiplier = 1 --default 1 Ranges from 14 - 27
poiTalusImperialVsRebelBattleMultiplier = 1 --default 1 Ranges from 14 - 26
poiTalusLostVillageOfDurbinMultiplier = 1 --default 1 Ranges from 10 - 25
poiTatooineAncientKraytDragonSkeletonMultiplier = 1 --default 1 Ranges from 122 - 336
poiTatooineFortTuskenMultiplier = 1 --default 1 Ranges from 16 - 62 / Tusken Witch Doctor 202 / Tusken Observer 227 / Tusken Executioner 263 / Tusken Carnage Champion 116
poiTatooineImperialDetachmentHqMultiplier = 1 --default 1 Ranges from 4 - 30
poiTatooineImperialOasisBaseMultiplier = 1 --default 1 Ranges from 4 - 44 / Bounty Hunter 99 / Chiss Male-Female 100
poiTatooineJawaTradersMultiplier = 1 --default 1 Ranges from 4 - 17 / Devaronian Male 100 / EG6 Power Droid 100
poiTatooineKraytGraveyardMultiplier = 1 --default 1 Ranges from 122 - 336
poiTatooineSandcrawlerNeMultiplier = 1 --default 1 Ranges from 6 - 49
poiTatooineVillageRuinsMultiplier = 1 --default 1 Ranges from 6 - 49 / Krayt Adolescent 336
poiYavin4BlueleafTempleMultiplier = 1 --default 1 Ranges from 30 - 42
poiYavin4ImperialBaseMultiplier = 1 --default 1 Ranges from 4 - 25 / AT-ST 125
poiYavin4WoolamanderTempleMultiplier = 1 --default 1 Ranges from 29 - 51
