...
caveEndorJindaRitualistCaveMultiplier = 1 --default 1 Ranges from 5 - 51
caveEndorKorgaCaveMultiplier = 1 --default 1 Ranges from 5 - 60
caveEndorOrphanedMarauderCaveMultiplier = 1 --default 1 Ranges from 44 - 55
caveLokDroidEngineerCaveMultiplier = 1 --default 1 Ranges from 12 - 20
caveLokGasMineMultiplier = 1 --default 1 Ranges from 9 - 9
caveLokImperialResearchFacilityMultiplier = 1 --default 1 Ranges from 1 - 39
caveLokNymPirateCaveMultiplier = 1 --default 1 Ranges from 12 - 20
caveNabooNarglatchCaveMultiplier = 1 --default 1 Ranges from 8 - 27
caveNabooPirateBunkerMultiplier = 1 --default 1 Ranges from 10 - 22
caveNabooVeermokCaveMultiplier = 1 --default 1 Ranges from 9 - 26
caveRoriBlackSunOutpostBunkerMultiplier = 1 --default 1 Ranges from 9 - 34
caveRoriBorgleBatCaveMultiplier = 1 --default 1 Ranges from 13 - 15
caveRoriGiantBarkMiteCaveMultiplier = 1 --default 1 Ranges from 10 - 38
caveRoriKobolaBunkerMultiplier = 1 --default 1 Ranges from 8 - 25
caveRoriPygmyTortonCaveMultiplier = 1 --default 1 Ranges from 12 - 26
caveTalusAakuanCaveMultiplier = 1 --default 1 Ranges from 11 - 31
caveTalusBinayrePirateBunkerMultiplier = 1 --default 1 Ranges from 9 - 22
caveTalusChunkerBunkerMultiplier = 1 --default 1 Ranges from 5 - 11
caveTalusDetainmentCenterMultiplier = 1 --default 1 Ranges from 14 - 35 Inquisitor is 120, dark prophet is 138, light prophet is 85
caveTalusErranSifMultiplier = 1 --default 1 Ranges from 45 - 67
caveTalusGiantDecayMiteCaveMultiplier = 1 --default 1 Ranges from 7 - 26
caveTalusGiantFynockCaveMultiplier = 1 --default 1 Ranges from 5 - 42
caveTalusKaymurraBiogenticResearchStationMultiplier = 1 --default 1 Ranges from 30 - 41
caveTalusLostAqualishCaveMultiplier = 1 --default 1e Ranges from 9 - 27
caveTalusWeaponsDepotMultiplier = 1 --default 1 Ranges from 9 - 34
caveTatooineHuttHideoutMultiplier = 1 --default 1 Ranges from 10 - 17
caveTatooineSennexCaveMultiplier = 1 --default 1 Ranges from 13 - 37
caveTatooineSquillCaveMultiplier = 1 --default 1 Ranges from 10 - 50
caveTatooineTuskenBunkerMultiplier = 1 --default 1 Ranges from 26 - 44 King is 100
