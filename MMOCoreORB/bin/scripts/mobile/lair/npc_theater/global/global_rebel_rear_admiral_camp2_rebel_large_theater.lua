global_rebel_rear_admiral_camp2_rebel_large_theater = Lair:new {
	mobiles = {
		{"rebel_rear_admiral_lair",1},
	},
	spawnLimit = 1,
...
addLairTemplate("global_rebel_rear_admiral_camp2_rebel_large_theater", global_rebel_rear_admiral_camp2_rebel_large_theater)
