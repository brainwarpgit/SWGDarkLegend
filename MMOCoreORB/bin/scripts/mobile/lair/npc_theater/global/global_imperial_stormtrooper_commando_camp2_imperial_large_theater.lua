global_imperial_stormtrooper_commando_camp2_imperial_large_theater = Lair:new {
	mobiles = {
		{"stormtrooper_commando_lair",1},
	},
	spawnLimit = 5,
...
addLairTemplate("global_imperial_stormtrooper_commando_camp2_imperial_large_theater", global_imperial_stormtrooper_commando_camp2_imperial_large_theater)
