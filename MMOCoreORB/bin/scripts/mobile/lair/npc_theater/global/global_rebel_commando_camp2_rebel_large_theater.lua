global_rebel_commando_camp2_rebel_large_theater = Lair:new {
	mobiles = {
		{"rebel_commando_lair",1},
	},
	spawnLimit = 5,
...
addLairTemplate("global_rebel_commando_camp2_rebel_large_theater", global_rebel_commando_camp2_rebel_large_theater)
