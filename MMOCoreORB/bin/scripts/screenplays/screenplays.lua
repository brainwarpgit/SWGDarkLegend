...
includeFile("tools/mission_random_attacks_choice.lua")
includeFile("tools/mission_random_attacks_choice_admin.lua")
includeFile("random/mission_random_attacks.lua")
