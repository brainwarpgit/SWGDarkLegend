CorelliaKorVellaScreenPlay = CityScreenPlay:new {
	...
	citySpawns = {
		--thugs
		{"ragtag_kook", 300, -3816.4, 86, 3114.2, 103, 0},
		{"ragtag_kook", 300, -3814.6, 86, 3109.6, 58, 0},
		{"ragtag_kook", 300, -3809.9, 86, 3111.1, -46, 0},
		{"ragtag_kook", 300, -3809.5, 86, 3117.4, -115, 0},
		{"ragtag_kook", 300, -3801.2, 86, 3251.2, 12, 0},
		{"ragtag_kook", 300, -3797.2, 86, 3251.1, 67, 0},
		{"ragtag_kook", 300, -3793.2, 86, 3255.3, -73, 0},
		{"ragtag_kook", 300, -3797.9, 86, 3259.9, -170, 0},
		{"ragtag_kook", 300, -3717.2, 86, 3074.9, 29, 0},
		{"ragtag_kook", 300, -3712.6, 86, 3073.8, 104, 0},
		{"ragtag_kook", 300, -3711.0, 86, 3077.6, -38, 0},
		{"ragtag_kook", 300, -3714.8, 86, 3079.9, 19, 0},
		{"ragtag_kook", 300, -3602.3, 86, 3105.7, -69, 0},
		{"ragtag_kook", 300, -3602.5, 86, 3107.6, 2, 0},
		{"ragtag_kook", 300, -3598.4, 86, 3107.5, -90, 0},
		{"ragtag_kook", 300, -3599.5, 86, 3112.2, 132, 0},
		{"ragtag_kook", 300, -3602.1, 86, 3115.1, -170, 0},
		{"ragtag_kook", 300, -3632.6, 86, 3232.5, 51, 0},
		{"ragtag_kook", 300, -3630.2, 86, 3236.7, 104, 0},
		{"ragtag_kook", 300, -3630.0, 86, 3232.6, -57, 0},
		{"ragtag_kook", 300, -3500.5, 78, 3148.0, 107, 0},
		{"ragtag_kook", 300, -3500.8, 78, 3145.0, 114, 0},
		{"ragtag_kook", 300, -3494.1, 78, 3140.4, -53, 0},
		{"ragtag_kook", 300, -3495.8, 78, 3146.1, -88, 0},
		{"ragtag_kook", 300, -3496.7, 78, 3138.3, 2, 0},
		{"ragtag_kook", 300, -3499.1, 70, 3239.0, 1, 0},
		{"ragtag_kook", 300, -3495.3, 70, 3240.8, 8, 0},
		{"ragtag_kook", 300, -3495.8, 70, 3243.1, -100, 0},
		{"ragtag_kook", 300, -3497.5, 70, 3245.9, -83, 0},
		{"ragtag_kook", 300, -3501.7, 70, 3244.5, 162, 0},
		{"ragtag_kook", 300, -3467.7, 85.6, 3182.2, 74, 0},
		{"ragtag_kook", 300, -3467.6, 85.9, 3175.1, 15, 0},
		{"ragtag_kook", 300, -3461.5, 85.4, 3179.1, -53, 0},
		{"ragtag_kook", 300, -3462.3, 85.1, 3186.0, 18, 0},
		{"ragtag_kook", 300, -3309.4, 86, 3285.4, -141, 0},
		{"ragtag_kook", 300, -3309.9, 86, 3281.3, -103, 0},
		{"ragtag_kook", 300, -3309.5, 86, 3276.9, -99, 0},
		{"ragtag_kook", 300, -3314.0, 86, 3277.9, 16, 0},
		{"ragtag_kook", 300, -3631.5, 86, 3117.4, -67, 0},
		{"ragtag_kook", 300, -3637.5, 86, 3114.4, 22, 0},
		{"ragtag_kook", 300, -3634.5, 86, 3119.4, -167, 0},
		{"ragtag_kook", 300, -3630.5, 86, 3119.4, -30, 0},
		{"ragtag_kook", 300, -3162.3, 31, 2999.6, 64, 0},
		{"ragtag_kook", 300, -3160.5, 31, 3001.3, 47, 0},
		{"ragtag_kook", 300, -3157.2, 31, 2999.4, 145, 0},
		{"ragtag_kook", 300, -3158.8, 31, 2994.4, -29, 0},
		{"ragtag_kook", 300, -3161.8, 31, 2991.5, -109, 0},
		{"ragtag_kook", 300, -3417.7, 86, 3118.9, 112, 0},
		{"ragtag_kook", 300, -3421.1, 86, 3120.9, 157, 0},
		{"ragtag_kook", 300, -3424.7, 86, 3115.9, -25, 0},
		{"ragtag_kook", 300, -3420.1, 86, 3112.9, 148, 0},

		--Creatures
		{"minor_gubbur", 300, getRandomNumber(10) + -3286, 101,getRandomNumber(10) + 2986, getRandomNumber(360), 0},
		{"minor_gubbur", 300, getRandomNumber(10) + -3286, 101,getRandomNumber(10) + 2986, getRandomNumber(360), 0},
		{"minor_gubbur", 300, getRandomNumber(10) + -3286, 101,getRandomNumber(10) + 2986, getRandomNumber(360), 0},
		{"minor_gubbur", 300, getRandomNumber(10) + -3286, 101,getRandomNumber(10) + 2986, getRandomNumber(360), 0},
		{"minor_gubbur", 300, getRandomNumber(10) + -3286, 101,getRandomNumber(10) + 2986, getRandomNumber(360), 0},
		{"minor_gubbur", 300, getRandomNumber(10) + -3286, 101,getRandomNumber(10) + 2986, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3177, 101,getRandomNumber(10) + 3084, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3177, 101,getRandomNumber(10) + 3084, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3177, 101,getRandomNumber(10) + 3084, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3177, 101,getRandomNumber(10) + 3084, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3177, 101,getRandomNumber(10) + 3084, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3177, 101,getRandomNumber(10) + 3084, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3249, 101, getRandomNumber(10) + 3308, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3249, 101, getRandomNumber(10) + 3308, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3249, 101, getRandomNumber(10) + 3308, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3249, 101, getRandomNumber(10) + 3308, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3249, 101, getRandomNumber(10) + 3308, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3249, 101, getRandomNumber(10) + 3308, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3335, 101, getRandomNumber(10) + 3383, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3335, 101, getRandomNumber(10) + 3383, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3335, 101, getRandomNumber(10) + 3383, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3335, 101, getRandomNumber(10) + 3383, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3335, 101, getRandomNumber(10) + 3383, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3335, 101, getRandomNumber(10) + 3383, getRandomNumber(360), 0},
		{"verne", 300, getRandomNumber(10) + -3389, 37, getRandomNumber(10) + 3531, getRandomNumber(360), 0},
		{"verne", 300, getRandomNumber(10) + -3389, 37, getRandomNumber(10) + 3531, getRandomNumber(360), 0},
		{"verne", 300, getRandomNumber(10) + -3389, 37, getRandomNumber(10) + 3531, getRandomNumber(360), 0},
		{"verne", 300, getRandomNumber(10) + -3389, 37, getRandomNumber(10) + 3531, getRandomNumber(360), 0},
		{"verne", 300, getRandomNumber(10) + -3389, 37, getRandomNumber(10) + 3531, getRandomNumber(360), 0},
		{"verne", 300, getRandomNumber(10) + -3389, 37, getRandomNumber(10) + 3531, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3519, 101, getRandomNumber(10) + 3469, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3519, 101, getRandomNumber(10) + 3469, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3519, 101, getRandomNumber(10) + 3469, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3519, 101, getRandomNumber(10) + 3469, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3519, 101, getRandomNumber(10) + 3469, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3519, 101, getRandomNumber(10) + 3469, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3698, 101, getRandomNumber(10) + 3397, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3698, 101, getRandomNumber(10) + 3397, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3698, 101, getRandomNumber(10) + 3397, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3698, 101, getRandomNumber(10) + 3397, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3698, 101, getRandomNumber(10) + 3397, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3698, 101, getRandomNumber(10) + 3397, getRandomNumber(360), 0},
		{"minor_gubbur", 300, getRandomNumber(10) + -3677, 101,getRandomNumber(10) + 3294, getRandomNumber(360), 0},
		{"minor_gubbur", 300, getRandomNumber(10) + -3677, 101,getRandomNumber(10) + 3294, getRandomNumber(360), 0},
		{"minor_gubbur", 300, getRandomNumber(10) + -3677, 101,getRandomNumber(10) + 3294, getRandomNumber(360), 0},
		{"minor_gubbur", 300, getRandomNumber(10) + -3677, 101,getRandomNumber(10) + 3294, getRandomNumber(360), 0},
		{"minor_gubbur", 300, getRandomNumber(10) + -3677, 101,getRandomNumber(10) + 3294, getRandomNumber(360), 0},
		{"minor_gubbur", 300, getRandomNumber(10) + -3677, 101,getRandomNumber(10) + 3294, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3808, 101,getRandomNumber(10) + 3347, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3808, 101,getRandomNumber(10) + 3347, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3808, 101,getRandomNumber(10) + 3347, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3808, 101,getRandomNumber(10) + 3347, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3808, 101,getRandomNumber(10) + 3347, getRandomNumber(360), 0},
		{"durni", 300, getRandomNumber(10) + -3808, 101,getRandomNumber(10) + 3347, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3797, 101, getRandomNumber(10) + 2958, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3797, 101, getRandomNumber(10) + 2958, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3797, 101, getRandomNumber(10) + 2958, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3797, 101, getRandomNumber(10) + 2958, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3797, 101, getRandomNumber(10) + 2958, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -3797, 101, getRandomNumber(10) + 2958, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3659, 101, getRandomNumber(10) + 2855, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3659, 101, getRandomNumber(10) + 2855, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3659, 101, getRandomNumber(10) + 2855, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3659, 101, getRandomNumber(10) + 2855, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3659, 101, getRandomNumber(10) + 2855, getRandomNumber(360), 0},
		{"vrelt", 300, getRandomNumber(10) + -3659, 101, getRandomNumber(10) + 2855, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3532, 101, getRandomNumber(10) + 2821, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3532, 101, getRandomNumber(10) + 2821, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3532, 101, getRandomNumber(10) + 2821, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3532, 101, getRandomNumber(10) + 2821, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3532, 101, getRandomNumber(10) + 2821, getRandomNumber(360), 0},
		{"paralope", 300, getRandomNumber(10) + -3532, 101, getRandomNumber(10) + 2821, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, -3217.9, 29.2, 2732.2, 87, 0},
		{"corellian_butterfly_drone", 300, -3220.2, 29.2, 2731.6, -111, 0},
		{"corellian_butterfly_drone", 300, -3220.7, 29.2, 2735.2, 1, 0},
		{"corellian_butterfly_drone", 300, -3217.6, 29.3, 2737.8, 57, 0},
		{"corellian_butterfly_drone", 300, -3219.4, 29.4, 2742.1, -50, 0},
		{"corellian_butterfly_drone", 300, -3223.1, 29.3, 2742.4, -87, 0},
		{"minor_gubbur", 300, -3005.4, 25.5, 2731.1, 60, 0},
		{"minor_gubbur", 300, -3001.2, 25.8, 2728.8, 118, 0},
		{"minor_gubbur", 300, -2998.3, 25.9, 2732.4, -18, 0},
		{"minor_gubbur", 300, -3001.0, 25.7, 2734.2, -60, 0},
		{"minor_gubbur", 300, -2996.4, 25.9, 2735.7, 77, 0},
		{"minor_gubbur", 300, -2994.2, 26.2, 2730.8, 177, 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -2981, 31, getRandomNumber(10) + 2988, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -2981, 31, getRandomNumber(10) + 2988, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -2981, 31, getRandomNumber(10) + 2988, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -2981, 31, getRandomNumber(10) + 2988, getRandomNumber(360), 0},
		{"corellian_butterfly_drone", 300, getRandomNumber(10) + -2981, 31, getRandomNumber(10) + 2988, getRandomNumber(360), 0},
